...
* [AI Segmentation by TerraLab](https://github.com/TerraLabAI/QGIS_AI-Segmentation) ⭐ 37 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - QGIS plugin that segments buildings, trees and any object from satellite and drone imagery into vector polygons.
...
* [OpenConstructionERP](https://github.com/datadrivenconstruction/OpenConstructionERP) ⭐ 744 | 🐛 17 | 🌐 TypeScript | 📅 2026-09-01 - Open-source construction cost estimation and project management with BOQ, 4D/5D planning, CAD/BIM takeoff, and regional cost items.
...
* [geo](https://github.com/georust/geo) ⭐ 1,920 | 🐛 123 | 🌐 Rust | 📅 2026-09-01 - Geospatial primitives, algorithms, and geometry operations.
