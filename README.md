...
* [AI Segmentation by TerraLab](https://github.com/TerraLabAI/QGIS_AI-Segmentation) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-09-18 - QGIS plugin that segments buildings, trees and any object from satellite and drone imagery into vector polygons.
...
* [OpenConstructionERP](https://github.com/datadrivenconstruction/OpenConstructionERP) ⭐ 835 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-19 - Open-source construction cost estimation and project management with BOQ, 4D/5D planning, CAD/BIM takeoff, and regional cost items.
* [BidWright](https://github.com/braedonsaunders/bidwright) ⭐ 55 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-10 - Open-source construction estimating with AI intake, 2D/3D/PDF/BIM takeoff, pricing, and quotes.
* [BeaconHS](https://github.com/braedonsaunders/beaconhs) ⭐ 5 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-18 - Open-source HSE platform for industrial construction: incidents, permits, inspections, and contractor safety.
...
* [geo](https://github.com/georust/geo) ⭐ 1,940 | 🐛 134 | 🌐 Rust | 📅 2026-09-19 - Geospatial primitives, algorithms, and geometry operations.
