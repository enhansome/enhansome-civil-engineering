...
[Edit/Update the list](https://github.com/QuantumNovice/awesome-civil-engineering) ⭐ 89 | 🐛 0 | 🌐 Python | 📅 2026-08-28
...
* [AI Segmentation by TerraLab](https://github.com/TerraLabAI/QGIS_AI-Segmentation) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-09-08 - QGIS plugin that segments buildings, trees and any object from satellite and drone imagery into vector polygons.
...
* [OpenConstructionERP](https://github.com/datadrivenconstruction/OpenConstructionERP) ⭐ 793 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-10 - Open-source construction cost estimation and project management with BOQ, 4D/5D planning, CAD/BIM takeoff, and regional cost items.
...
* [ArchGDAL.jl](https://github.com/yeesian/ArchGDAL.jl) ⭐ 151 | 🐛 97 | 🌐 Julia | 📅 2026-09-06 - GDAL bindings for raster and vector geospatial workflows.
...
* [geo](https://github.com/georust/geo) ⭐ 1,930 | 🐛 135 | 🌐 Rust | 📅 2026-09-07 - Geospatial primitives, algorithms, and geometry operations.
* [gdal](https://github.com/georust/gdal) ⭐ 448 | 🐛 63 | 🌐 Rust | 📅 2026-07-06 - GDAL bindings for geospatial raster and vector data.
